...
var reduxForm = function reduxForm(config, parentMapStateToProps) {
  ...
  return function (CompNode) {
    var Wrapped = function (_Component) {
      ...
      _createClass(Wrapped, [{
        ...
        value: function componentDidMount() {
          ...
          this.props.dispatch((0, _actions.initialize)(config.form, initialValues));
        }
      }, {
    ...
    function mapStateToProps(store, ownProps) {
      ...
      if (parentMapStateToProps) {
        ...
        return _extends({}, parentMapStateToProps(store, ownProps), (_extends2 = {}, _defineProperty(_extends2, config.form, others), _defineProperty(_extends2, 'formFields', fields), _extends2));
      }

      return _ref = {}, _defineProperty(_ref, config.form, others), _defineProperty(_ref, 'formFields', fields), _ref;
    }

    return _reactRedux.connect.apply(undefined, [mapStateToProps].concat(rest))(_antd.Form.create({

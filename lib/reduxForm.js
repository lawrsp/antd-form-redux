...
var _form2 = require('antd/lib/form');
...
var compareEqual = function compareEqual(a, b) {
  ...
  for (var i = 0; i < keysA.length; i++) {
    ...
    if (!(0, _isEqual2.default)(a[k], b[k])) {
      return false;
    }
  }
...
var reduxForm = function reduxForm(_ref) {
  ...
  return function (CompNode) {
    ...
    var wrappedComp = function (_Component) {
      ...
      _createClass(wrappedComp, [{
        ...
        value: function componentDidMount() {
          var iv = this.props.initialValues || initialValues;
          if (iv) {
            this.props.dispatch((0, _actions.initialize)(_form, initialValues));
            var _form = this.props;
    ...
    return (0, _reactRedux.connect)(mapStateToProps)(_form3.default.create({
      ...
      mapPropsToFields: function mapPropsToFields(props) {
        ...
        var maps = (0, _keys2.default)(fields).reduce(function (o, k) {
          return _extends({}, o, _defineProperty({}, k, _form3.default.createFormField(fields[k])));
        }, {});

  ...
  return function (CompNode) {
    ...
    function mapStateToProps(store) {
      ...
      if (parentMapStateToProps) {
        ...
        return _extends({}, parentMapStateToProps(store), (_extends2 = {}, _defineProperty(_extends2, config.form, others), _defineProperty(_extends2, 'formFields', fields), _extends2));
      }

...
var reduxForm = function reduxForm(_ref) {
  var _ref$reducer = _ref.reducer,
      ...
      _ref$validateFieldsKe = _ref.validateFieldsKey,
      validateFieldsKey = _ref$validateFieldsKe === undefined ? 'validateFields' : _ref$validateFieldsKe,
  ...
  return function (CompNode) {
    ...
    var wrappedComp = function (_Component) {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = wrappedComp.__proto__ || Object.getPrototypeOf(wrappedComp)).call.apply(_ref2, [this].concat(args))), _this), _this.handleSubmit = function (e) {
          ...
          _this.props.form.validateFields(function (err, values) {
            if (!err) {
              ...
              onSubmit(values, disptach, _this.props);
              return;
            }
      ...
      _createClass(wrappedComp, [{
        ...
        value: function render() {
          var addedProps = _defineProperty({}, validateFieldsKey, this.props.form.validateFields);
          if (this.props.onSubmit) {
            addedProps.onSubmit = this.handleSubmit;
          }

          return _react2.default.createElement(CompNode, _extends({}, this.props, addedProps));
        }
      }]);
    ...
    function mapStateToProps(store, props) {
      ...
      var mergedProps = (_mergedProps = {}, _defineProperty(_mergedProps, key, others), _defineProperty(_mergedProps, formFieldsKey, fields), _defineProperty(_mergedProps, 'onSubmit', props.onSubmit || onSubmit), _mergedProps);
    ...
    return (0, _reactRedux.connect)(mapStateToProps)(_antd.Form.create({
      ...
      mapPropsToFields: function mapPropsToFields(props) {
        ...
        var result = Object.keys(formFields).reduce(function (o, i) {
